<template>
  <header class="header">
        ...
        <div class="header__top-inner">
          <div class="header__sm">
              <a class="header__sm-item" href="https://facebook.com">
                    <svg class="header__sm-item-img" width="7" height="13" viewBox="0 0 7 13" fill="none"
                ...
                <a class="header__sm-item" href="https://instagram.com">
                    <svg class="header__sm-item-img" width="13" height="13" viewBox="0 0 13 13" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a class="header__sm-item" href="https://youtube.com">
                    <svg class="header__sm-item-img" width="16" height="12" viewBox="0 0 16 12" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
          ...
          <div class="header__auth">
            <nuxt-link class="header__auth-link" to="/"><img class="header__auth-img" src="images/icons/user.svg" alt="">Вход</nuxt-link>
            <nuxt-link class="header__auth-link" to="/">Регистрация</nuxt-link>
          </div>
          <div class="header__lang">Ru<img src="images/icons/arrow-down.svg" alt="">
    ...
    <div class="header__main">
      <div class="container">
        <div class="header__inner">
          <nuxt-link class="logo" to="/"><img src="images/logo.svg" alt=""></nuxt-link>
          <div class="header__contacts">
            <a class="header__contacts-item" href="#"><img src="images/icons/viber.svg" alt=""></a>
            <a class="header__contacts-item" href="#"><img src="images/icons/telegram.svg" alt=""></a>
            <a class="header__contacts-item" href="#"><img src="images/icons/whatsapp.svg" alt=""></a>
            <div class="header__contacts-item">
              <a class="header__contacts-phone" href="tel:380447505011"><span>+38 (044)</span> 750-50-11</a>
              <a class="header__contacts-phone" href="tel:380977755051"><span>+38 (097)</span> 775-50-51</a>
            </div>
          </div>
          <div class="header__callback">
            <my-button class="header__callback-btn">Заказать звонок</my-button>
            <div class="header__callback-text">Ждем Вашего звонка ежедевно с 9 до 18</div>
          </div>
          <nuxt-link class="header__basket" to="/">
            <img src="images/icons/basket.svg" alt=""><span class="header__basket-num">0</span>
          </nuxt-link>
        </div>
      </div>
    </div>
    <div class="container">
      <nav class="menu">
        <ul class="menu__list">
          <li class="menu__list-item"><nuxt-link class="menu__list-link" to="/">Магазин</nuxt-link></li>
          <li class="menu__list-item"><nuxt-link class="menu__list-link" to="/">О производстве</nuxt-link></li>
          <li class="menu__list-item"><nuxt-link class="menu__list-link" to="/">Оплата и доставка</nuxt-link></li>
          <li class="menu__list-item"><nuxt-link class="menu__list-link" to="/">Оптовым и корпоративным клиетам</nuxt-link></li>
          <li class="menu__list-item"><nuxt-link class="menu__list-link" to="/">Новости и статьи</nuxt-link></li>
          <li class="menu__list-item"><nuxt-link class="menu__list-link" to="/">Галерея</nuxt-link></li>
        </ul>
      </nav>
    </div>
  </header>
